<?php
// source: /var/www/VideaCeskyDownloader/app/templates/Index/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2091805339', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb87a87a69fc_content')) { function _lb87a87a69fc_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="row">
