<?php
// source: /var/www/vcDownloader/app/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8573170663', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb39fcda9c4b_content')) { function _lb39fcda9c4b_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb7ae3b637bb_title')) { function _lb7ae3b637bb_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb4fde69ed6c_scripts')) { function _lb4fde69ed6c_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb974e97db7b_head')) { function _lb974e97db7b_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
